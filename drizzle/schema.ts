import { pgTable, foreignKey, pgPolicy, uuid, timestamp, text, unique } from "drizzle-orm/pg-core"
...
export const profiles = pgTable("profiles", {
	...
	pgPolicy("Profiles are viewable by self.", { as: "permissive", for: "select", to: ["public"] }),
]);
